...
for name in nm_subj:
    ...
    final = fmri_dataset(samples = path_func, targets =  label.targets, chunks = label.chunks, mask = path_mask)
...
#res = (res_ws, res_hyp)
path_save = path + path_s + 'anova1000_svm_all_hyp.train.txt'
