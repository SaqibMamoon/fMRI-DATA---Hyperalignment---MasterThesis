...
#define path
path ='/home/andreabertana/Projects/HCP/results/MNI/WM/results/distribution/'
...
#define path to save
path_save = '/home/andreabertana/Projects/HCP/results/MNI/WM/plot/anova_LSVM_boxplot_1.png'
...
plt.title('WM task: BSC accuracy after anatomical and hyperalignment',fontsize = 24)
#set colors
...
for i in range(numBoxes):
    ...
    plt.plot([np.average(med.get_xdata())], [np.average(data[i])],
           color='r', marker='*', markeredgecolor='r')
